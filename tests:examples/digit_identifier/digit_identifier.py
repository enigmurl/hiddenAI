...
mndata = MNIST(parent_directory + "datasets/digitdata")
...
net.open_from_file("digit_identifier/digitweight")# open up from digitweight a pre trained model
...
net.save_from_file("digit_identifier/digitweight")# open up from digitweight a pre trained model
#ASSESING THE MODEL
